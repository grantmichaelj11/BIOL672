...
data<-read.table("C:/Users/Grant/OneDrive/Homework/Fall 2023/BIOL672/iris_tab.txt",header=TRUE)
...
sink(file = 'C:/Users/Grant/OneDrive/Homework/Fall 2023/BIOL672/meansIRIS.txt')
print(iris.means)
